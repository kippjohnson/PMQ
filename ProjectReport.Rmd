...
opennessdivergencealpha <- alpha( data.frame(c( infile3[,c("Q1","Q7","Q10","Q12")], divergence_corrected) ))
...
subset369  <- alpha(infile3[,c("Q3","Q6","Q9")])$total[[1]] #unavoidable warning message...
...
colnames(gen_out_covark) <- c("P Value", "Significant (1=Yes, 0=No)")
...
```{r, echo=FALSE}
ddply(infile3, ~Q27, summarize, mean=mean(genomicknowledge, na.rm=TRUE), N=length(genomicknowledge))
ddply(infile3, ~Q28.2c, summarize, mean=mean(genomicknowledge, na.rm=TRUE), N=length(genomicknowledge))
ddply(infile3, ~Q29.2, summarize, mean=mean(genomicknowledge, na.rm=TRUE), N=length(genomicknowledge))
```
...
gen_30.1c <- anova(lm(infile3$genomiccomfort ~ as.factor(infile3$Q30.1)))
...
colnames(gen_out_covarc) <- c("P Value", "Significant (1=Yes, 0=No)")
rownames(gen_out_covarc) <- c("Question 26","Question 27","Question 28.2","Question 29.1","Question 29.2","Question 30.1","Question 30.2")

kable(gen_out_covarc,caption="Genomic Ability Covariate ANOVA Analysis (P-Values)")
```

```{r, echo=FALSE}
ddply(infile3, ~Q27, summarize, mean=mean(genomiccomfort, na.rm=TRUE), N=length(genomiccomfort))
