...
## 29.1
infile3$Q29.1.fNA <- (as.factor(infile3$Q29.1))
infile3_naomit <- infile3[which(!is.na(infile3$Q29.1.fNA)) , ]
levels(infile3_naomit$Q29.1.fNA) <- c('No','Yes')

g3 <- ggplot(data=infile3_naomit, aes(factor(Q29.1.fNA), fill=Q9cf), aes(y=..count../sum(..count..))) + 
      geom_bar(position="fill", binwidth=0.25 )+ 
