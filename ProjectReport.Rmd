...
q14.1 <- c(s14$N[1], s14$mean[1], s14$SD[1], CT14$p.value)
q14.2 <- c(s14$N[2], s14$mean[2], s14$SD[2], CT14$p.value)
q15.1 <- c(s15$N[1], s15$mean[1], s15$SD[1], CT15$p.value)
q15.2 <- c(s15$N[2], s15$mean[2], s15$SD[2], CT15$p.value)
q16.1 <- c(s16$N[1], s16$mean[1], s16$SD[1], CT16$p.value)
q16.2 <- c(s16$N[2], s16$mean[2], s16$SD[2], CT16$p.value)
q17.1 <- c(s17$N[1], s17$mean[1], s17$SD[1], CT17$p.value)
q17.2 <- c(s17$N[2], s17$mean[2], s17$SD[2], CT17$p.value)
q18.1 <- c(s18$N[1], s18$mean[1], s18$SD[1], CT18$p.value)
q18.2 <- c(s18$N[2], s18$mean[2], s18$SD[2], CT18$p.value)
q19.1 <- c(s19$N[1], s19$mean[1], s19$SD[1], CT19$p.value)
q19.2 <- c(s19$N[2], s19$mean[2], s19$SD[2], CT19$p.value)
q20.1 <- c(s20$N[1], s20$mean[1], s20$SD[1], CT20$p.value)
q20.2 <- c(s20$N[2], s20$mean[2], s20$SD[2], CT20$p.value)
q21.1 <- c(s21$N[1], s21$mean[1], s21$SD[1], CT21$p.value)
q21.2 <- c(s21$N[2], s21$mean[2], s21$SD[2], CT21$p.value)
q22.1 <- c(s22$N[1], s22$mean[1], s22$SD[1], CT22$p.value)
q22.2 <- c(s22$N[2], s22$mean[2], s22$SD[2], CT22$p.value)
q23.1 <- c(s23$N[1], s23$mean[1], s23$SD[1], CT23$p.value)
q23.2 <- c(s23$N[2], s23$mean[2], s23$SD[2], CT23$p.value)
q24.1 <- c(s24$N[1], s24$mean[1], s24$SD[1], CT24$p.value)
q24.2 <- c(s24$N[2], s24$mean[2], s24$SD[2], CT24$p.value)
q25.1 <- c(s25$N[1], s25$mean[1], s25$SD[1], CT25$p.value)
q25.2 <- c(s25$N[2], s25$mean[2], s25$SD[2], CT25$p.value)
...
colnames(out) <- c("N","Mean","SD","P-Value")
